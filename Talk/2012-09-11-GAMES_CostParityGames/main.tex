...
\begin{picture}(40,60)(0,0)
	\gasset{Nw=8,Nh=8}
  	...
  	\node(Eve)(10,35){}
	\put(16,34){controlled by Player $0$}
  	\rpnode[polyangle=45](Adam)(10,25)(4,5){}
	\put(16,24){controlled by Player $1$}
\end{picture}
\end{multicols}
\end{frame}

\begin{frame}{Winning conditions: requests and responses}
...
\begin{itemize}
	\item Player $0$ has positional winning strategies.
	\item Player $1$ needs infinite memory.
...
\begin{theorem}
To decide the winner in a cost-parity game,\\
it suffices to decide the winner in polynomially many parity games which are polynomially larger.
\end{theorem}
\vskip2em
\pause
Proof: a fixpoint algorithm.
%\pause
%\vskip2em
%\begin{corollary}
%Player $0$ has finite-memory winning strategies in cost-parity games.
%\end{corollary}
\end{frame}

\begin{frame}{Positional determinacy for Player $0$}
